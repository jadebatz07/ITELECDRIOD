package com.example.mylistviewpicture;
...
public class MainActivity extends Activity implements OnItemClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		list.add(new Student(R.drawable.img2,"Charlie, Hotel","BSCREAM"));
		list.add(new Student(R.drawable.img3,"Mike, India","BSCOE"));
		list.add(new Student(R.drawable.img4,"November, Kilo","AB"));
		list.add(new Student(R.drawable.img5,"Oscar, Quebec","BSHRM"));
		list.add(new Student(R.drawable.img6,"Zulu, Uniform","BSA"));
		list.add(new Student(R.drawable.img7,"Delta, Tango","BSBA"));
		list.add(new Student(R.drawable.img8,"Juliet, Sierra","BSEE"));
